...
namespace kara::builder {
    std::optional<builder::Result> Scope::convert(const builder::Result &r, const utils::Typename &type, bool force) {
        ...
        && typeRef->kind == utils::ReferenceKind::Regular
    ...
    std::optional<utils::Typename> Scope::negotiate(const utils::Typename &left, const utils::Typename &right) {
        ...
        if (leftPrim && rightPrim && leftPrim->isNumber() && rightPrim->isNumber()) {
            ...
            utils::PrimitiveType type = ([&]() {
                if (isFloat) {
                    switch (size) {
                        case 8: return utils::PrimitiveType::Double;
                        case 4: return utils::PrimitiveType::Float;
                        default: throw;
                    }
                }
                ...
                if (isSigned) {
                    switch (size) {
                        case 8: return utils::PrimitiveType::Long;
                        case 4: return utils::PrimitiveType::Int;
                        case 2: return utils::PrimitiveType::Short;
                        case 1: return utils::PrimitiveType::Byte;
                        default: throw;
                    }
                } else {
                    switch (size) {
                        case 8: return utils::PrimitiveType::ULong;
                        case 4: return utils::PrimitiveType::UInt;
                        case 2: return utils::PrimitiveType::UShort;
                        case 1: return utils::PrimitiveType::UByte;
                        default: throw;
                    }
                }
            })();
    ...
    std::optional<std::pair<builder::Result, builder::Result>> Scope::convert(
        const builder::Result &a, Scope &aScope,
        const builder::Result &b, Scope &bScope) {
    ...
    void Scope::invokeDestroy(const builder::Result &result) {
    ...
    builder::Result Scope::infer(const Wrapped &result) {
        return std::visit(overloaded {
            [&](const builder::Unresolved &result) -> builder::Result {
            ...
            try {
                if (node->op == parser::Assign::Operator::Assign) {
                    ...
                    auto operation = ([op = node->op]() {
                        switch (op) {
                            case parser::Assign::Operator::Plus: return utils::BinaryOperation::Add;
                            case parser::Assign::Operator::Minus: return utils::BinaryOperation::Sub;
                            case parser::Assign::Operator::Multiply: return utils::BinaryOperation::Mul;
                            case parser::Assign::Operator::Divide: return utils::BinaryOperation::Div;
                            case parser::Assign::Operator::Modulo: return utils::BinaryOperation::Mod;
